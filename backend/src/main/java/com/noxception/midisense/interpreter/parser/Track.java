...
public class Track {
    ...
    /**
     * A list of all the properties possessed by a note that must be retained
     */
    private static final Map<String,Method> properties = new HashMap<>();
    ...
    private String noteToString(Note note){
        ...
        //get a list of note properties from predefined methods
        try {
            for(String field: properties.keySet()){
                Method method = properties.get(field);
                field = "\""+field+"\"";
    ...
    private void loadProperties(){
        if(properties.isEmpty()){
            for(Method method: Note.class.getMethods()){
                //if there is a getter, save it to list of accessible properties and store the response of the attribute
