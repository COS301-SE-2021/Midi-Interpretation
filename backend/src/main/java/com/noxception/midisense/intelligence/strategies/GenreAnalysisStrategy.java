...
/**
 * Provides an interface for a strategy used to analyse the genre of a track. Makes up the abstract strategy of the
...
public interface GenreAnalysisStrategy {
    ...
    GenrePredication[] classify(byte[] features);
}
